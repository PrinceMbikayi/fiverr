...
export const IconButton = (props) => {
    ...
    const iconBackgroundColor = 'transparent' || theme['widget--round--wrapper--color--background'] || props.backgroundColor;
    ...
    return  (
        <>
            <StyledIconWrapperBlockView size={iconSize*(1.5)} backgroundColor={iconWrapperColor}> 
                <TouchableHighlight activeOpacity={0.3} underlayColor="#DDDDDD" style={{borderRadius:iconSize}} onPress={()=>{onAction()}}>                       
