...
import {logWithApple} from '_api/social';
 ...
 */
 ...
 export const onAppleButtonPress = async(updateCredentialStateForUser) =>{
  await logWithApple();
...
export const no_onAppleButtonPress = async(updateCredentialStateForUser) =>{
