...
import DoorKeeperWizardStartPreinstall from './doorKeeperWizardPreInstall';
import {HeaderWithBack} from '_components/headers/header-with-back';



const DoorKeeperWizardStartScreen = (props) => {
   ...
   const navigationParams = route?.params || {}; 
    ...
    useEffect(() => {
      ...
      const _startInstallation = () => {
        ...
        navigation.navigate('AddDoorKeeperReadQRCode',params);       
      }
    ...
    return (
        <SafeAreaView style={{flex:1,backgroundColor:backgroundColor}}>            
          <ScreenHeader/>          
          <DoorKeeperWizardStartPreinstall indexCallback={wizardStartPosition} currentPosition={startInstallIndex} endCallback={_startInstallation.bind(this)} />      
        </SafeAreaView>
    )        
}

export default DoorKeeperWizardStartScreen
