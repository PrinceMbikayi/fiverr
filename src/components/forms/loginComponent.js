             ...
             return ( <>
              <WithTranslateFormErrors errors={errors} touched={touched} setFieldTouched={setFieldTouched}>
               <View style={{backgroundColor:'transparent'}}>
                  ...
                  <FormInput name='password' value={values.password}  placeholder={t('Enter password')} secureTextEntry passwordToggle   onChangeText = {onChangeWithRulesExternal('password',noSpace)(values,setFieldValue)}  ref={passwordRef} returnKeyType='done' iconName='ios-lock' iconColor='#2C384A' bgColor={bgColor} addTestId = {passwordID}/>              
                  <TouchableOpacity onPress={() => getForgottenPassword(values)} {...forgottenPasswordID}>
