...
export const ScenarioContextProvider = ({ children, ...props }) => {
    ...
    const objectsToExclude = getRoutinePossibleObject(["Composite", "Weather", "Sonde", "Netatmo", "Remote", "WeeklyPlanner","Application","TriggerGate"], objectsTypes)
    ...
    const [ecoTargetForDelete, setEcoTargetForDelete] = useState();
    ...
    const [ecoConfortIdentity, setEcoConfortIdentity] = useState(
                {   ecoConfortId:null, ecoConfortName:null,mode:"summer",sensorId:null,
                    ...
                    activeDays:[], startTime:"8:0", stopTime:"20:0"
                }
        );
    ...
    ///////////------WIND PROTECTION
    const [windProtectionIdentity, setWindProtectionIdentity] = useState({
    ...
    const [shuttersToprotect, setShuttersToProtect] = useState([]);


    useEffect(()=> {
        console.log('WIND_PROTECTION_IDENTITY :', windProtectionIdentity);
    },[windProtectionIdentity]);

    useEffect(()=> {
        console.log('SHUTTERS_TO_PROTECT :', shuttersToprotect);
    },[shuttersToprotect]);
...
//####======================================================================####
    ...
    useEffect(()=> {
        console.log('ECO_TARGET_FOR_DELETE :', ecoTargetForDelete);
    },[ecoTargetForDelete]);
    ...
    const shared = {
        ...
        selectedDay,
        updateDaySelection,setSelectedDay,
        dayActive,
        ...
        weeklyPlannerId, ecoTargetForDelete, setEcoTargetForDelete,
        weeklyPlanner,
