...
const LoginScreen = (props) => {
    ...
    const { move, subscribreStep, showServerSelectorTap, submit, goBack, confirmSubmit, pageIndex, userId = '', userPassword = '', goForgottenPassword } = props;
                ...
                <View style={{ backgroundColor: bgcolor, padding: 20, paddingTop: 40, justifyContent: 'flex-start', }}>
                    ...
                    <View>
                        ...
                        <ScrollView style={{ height: 320, backgroundColor:'transparent' }} showsVerticalScrollIndicator={false} >
                            ...
                            <TouchableOpacity activeOpacity={1} onPress={goForgottenPassword} touchSoundDisabled={true} style={{marginTop:20}}>
