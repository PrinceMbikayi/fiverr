...
export const BoxItem = (props)=>{
    ...
    return(
        ...
        <View style={{justifyContent:'flex-start', alignItems:'flex-start',backgroundColor:'transparent'}}>
            ...
            <View style={{ alignItems:'center', justifyContent:'flex-start', backgroundColor:connected ? 'transparent' : nonConnectedGray,
                            width:'100%', flexDirection:'row', opacity:connected ? 1 : 0.5
                        }}>
