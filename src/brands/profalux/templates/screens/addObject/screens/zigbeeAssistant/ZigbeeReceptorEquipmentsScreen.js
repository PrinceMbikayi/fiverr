...
import { View,Text,StyleSheet,SafeAreaView, ActivityIndicator, Dimensions,Image} from 'react-native';
...
const goBackFromLocalizeButton = ()=>{
    goPage(0)
    clearTimeout(timerRef.current);
}
...
const RenderLoading=()=>{
    return(
        <View style={{ marginTop: 10 }}>
            <Text style={[styles.text, { marginTop: 0, marginBottom: 30 }]}>
                ...
                //onPageScrollStateChanged={(e) => console.log(e)}
                        >
                            ...
                            <View key='0' style={{alignItems:'center', justifyContent:'flex-start', backgroundColor:'transparent', paddingTop:20}}>
                                <HeaderScreen title =  {t(tns+":"+"ADD_EQUIP_RECEPTOR_CALYPSHOME")}  goBack={()=>navigation.navigate("ZigbeeAssistantHomeScreen")}/>
                            ...
                            <View key='1' style={{alignItems:'center', justifyContent:'flex-start', backgroundColor:'transparent', paddingTop:20}}>
                                <HeaderScreen title =  {t(tns+":"+"ADD_EQUIP_RECEPTOR_CALYPSHOME")}  goBack={goBackFromLocalizeButton}/>
                                <Body style={{marginTop:0, padding:15}}>
                                    ...
                                    <View>
                                        ...
                                        <View style={{backgroundColor:'white',padding:10,borderColor:'orange',borderWidth:1,borderRadius:8, width:225,justifyContent:'center',alignSelf:'center'}}>
                                            <Image 
                                                source={require('_brand/templates/screens/addObject/images/receptor-showbutton.png')}
                                                style={{height:100,width:100, resizeMode:'contain', alignSelf:'center',aspectRatio:1.6}}
                                                />
                                        </View>
                                        <View style={{ marginTop: 5, marginBottom: 10, justifyContent:'center',alignItems:'center' }}>
                                        ...
                                        <View style={{backgroundColor:'white',padding:10,borderColor:'orange',borderWidth:1,borderRadius:8, width:225,justifyContent:'center',alignSelf:'center'}}>
                                            <Image 
                                                source={require('_brand/templates/screens/addObject/images/shutter-mouvement.png')}
                                                style={{height:100,width:100, resizeMode:'contain', alignSelf:'center',aspectRatio:1.6}}
                                                />
                                        </View>
                            ...
                            <View key='2' style={{ alignItems: 'center', justifyContent: 'flex-start', backgroundColor: 'transparent', paddingTop: 20 }}>
                                <HeaderScreen title={t(tns + ":" + "ADD_EQUIP_RECEPTOR_CALYPSHOME")} withBack={false} goBack={cancelLoading } />
                                <Body>
                                        <View>
                    ...
                    <View key="3" style={{ alignItems: 'center', justifyContent: 'flex-start', backgroundColor: 'transparent', paddingTop: 20 }} >
                        <HeaderScreen title={t(tns + ":" + "ADD_EQUIP_RECEPTOR_CALYPSHOME")} goBack={()=>goPage(0)} />
                        <Body>
                    ...
                    <View key='4' style={{ alignItems: 'center', justifyContent: 'flex-start', backgroundColor: 'transparent', paddingTop: 20 }}>
                        <HeaderScreen title={t(tns + ":" + "ADD_EQUIP_RECEPTOR_CALYPSHOME")} goBack={()=>goPage(3) } />
