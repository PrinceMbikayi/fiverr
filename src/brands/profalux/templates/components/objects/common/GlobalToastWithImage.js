...
export const GlobalToastWithImage = (props) => {
  ...
  const textColor = theme?.prflxTextColor || 'black';
    ...
    return (
      <View style= {{backgroundColor: toastBgColor||'#F2F2F2',opacity:0.9, borderRadius:14, padding: 0, justifyContent:'center', alignItems:'center'}}>
         {/* <View>
            <Text style={{color:titleColor || textColor, fontSize:17, fontWeight:'600', marginTop:10,textAlign:'center', backgroundColor:'transparent'}}> 
              {toastTitle} 
            </Text>
         </View> */}
