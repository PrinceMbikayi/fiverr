...
import GroupRenderTemplate from "./GroupRenderTemplate";
...
const GroupRender = ({name,...props}) => {
  ...
  /*
   ...
   const getTypeDynamic = () => {
    return (<TypeDynamic type={typeName} itemId={itemId} uObject={uObject}/>)
   }
   ...
   const goSettings = (props) => {
    ...
    return (
      <GroupRenderTemplate {...{itemId,availableCommands,netInfoIsConnected,forceDisplay,typeDynamic:getTypeDynamic(),'goLevel2' : expandMore,'goSettings' : goSettings}} />
    )
...
const Exp = React.memo(GroupRender,areEqual);
/*
PureItemRender.propTypes = {
  value: PropTypes.string.isRequired,
  onChange: PropTypes.func.isRequired,
};
PureItemRender.displayName = 'PureItemRender';
*/
export default Exp
