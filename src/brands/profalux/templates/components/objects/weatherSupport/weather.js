    ...
    <StyledMainView style={{ flexDirection: "row" }}>
      <View style={{ flex: 1, flexDirection: "column" }}>
        <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
          ...
          <TemperatureText color={textColor}>
            {Math.round(statuses.temperature)} °C
          </TemperatureText>
        </View>
        <View
          style={{
        ...
        >
          ...
          >
            <Image
              source={require("_images/weather/barometer.png")}
      ...
      <View style={{ flex: 1, flexDirection: "column" }}>
        <View style={[styles.infoLine]}>
          <Image
            source={require("_images/weather/soleil.png")}
        ...
        <View style={[styles.infoLine]}>
          <Image
            source={require("_images/weather/lune.png")}
            style={[styles.icon, { tintColor: iconColor }]}
          />
        ...
        <View style={[styles.infoLine]}>
          <Image
            source={require("_images/weather/wind.png")}
            style={[styles.icon, { tintColor: iconColor }]}
          />
