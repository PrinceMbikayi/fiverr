...
export const QrCodeVDPCallTemplate= (props) => {
    ...
    const {uObject,isRinging,videoPresent,goSettings,
        startConversation,endConversation,itemId,sentTime,statuses,
  ...
  //  const [isRinging,setIsRinging] = useState(false);
    ...
    */
    ...
    return (
                ...
                <View style={{backgroundColor:'blue',flex:1,height:'100%',width:'100%'}}>
                
                <ScrollView  alwaysBounceVertical={false}>
                <View style={[{backgroundColor:'green'|| realBackgroundColor},(myOrientation == 'portrait' || myOrientation == undefined) ? {flex:1}:{width: Dimensions.get('window').width,height: Dimensions.get('window').height-84}]}>               
                        { (isRinging) && 
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{width:'100%',height:screenHeight || screenWidth/videoRatio,flex:1,position:'relative',backgroundColor:'red'}}>
                                {children}
