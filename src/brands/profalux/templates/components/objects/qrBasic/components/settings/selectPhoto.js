...
import { Text,View,SafeAreaView,ScrollView,Button,Image,Modal,ImageBackground,Platform} from 'react-native';
...
const SelectPhoto = React.forwardRef((props, ref) => {
    ...
    const {children,callback,onLayout} = props;
    ...
    return (    <View onLayout={doOnLayout}>
