...
import { Keyboard,KeyboardAvoidingView,View,Text,TextInput,Button,Image,Modal,Pressable,Animated,Easing} from 'react-native';
 ...
 const SelectPhotoModal = React.forwardRef((props, ref) => {
  ...
  useEffect(() => {
   ...
   const gHeightRef = useRef(0)
    ...
    return (
       <KeyboardAvoidingView style={{backgroundColor:'transparent'}}  contentContainerStyle={{paddingBottom:keyboardStatus ? extraOffset : 0}} behavior={Platform.OS === "ios" ? "padding" : "position"}  nobehavior="position" >
