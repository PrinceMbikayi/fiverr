    ...
    const ScreenHeader = () => {
      ...
      const hGoback = (startInstallIndex == 0)? goBack : goBackStartPager;
       return  <View style={{height:84,alignItems:'center',justifyContent:'center'}}>
                        <HeaderWithBack backSVG noBack title={hTitle} goBack={{action:hGoback}} noShadow bgColor="transparent" extraButtons={[{action:close,svgr:<CloseCircle/>}]}/>
                    </View>       
    }    
