...
const QrPublicWizardInputsTemplateScreen = (props) => {
    ...
    console.log("QrPublicWizardInputsTemplateScreen",props)
   ...
   const navigationParams = route?.params || {}; 
    ...
    const tempSubmit = () => {
      formRef.current.submitForm();
      //console.log("temoSubmit",values)
    }

    const isSubmitted = (values) => {
     // console.log("isSubmitted",values,onSubmit)
     onSubmit(values);
    }
            ...
            <SafeAreaView style={{flex:1,backgroundColor:backgroundColor}}>            
              ...
              <ScrollView style={{paddingBottom:0,marginBottom:0}}> 
                <Body>
                  ...
                  <QrCodeSettingsForm callback={isSubmitted} buttonLabel={t("qrbasic:CONTINUE")} ref={formRef}/>
                  <View style={{height:8}}/>   
                  <Button title={t("account:REINIT_PASSWORD_SUBMIT")} onPress={tempSubmit} /*submitForm*/  bgColor={theme.primary_1_light}   />
