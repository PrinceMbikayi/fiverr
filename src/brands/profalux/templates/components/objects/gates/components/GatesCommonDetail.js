...
export const GatesCommonDetail = (props) => {
                            ...
                            <>
                                {isRoutine ?
                                    ...
                                    <Pressable
                                        ...
                                        style={{
                                            width: 124, height: 52, borderColor: '#3E495E', borderWidth: 2, borderRadius: 7,
                                    ...
                                    >
                                        <Text style={{ fontSize: 16, fontWeight: '600', color: actionActive ? 'white' : textColor }}>{t(tns + ":" + "GATE_DOOR_ACTION")}</Text>
                                    </Pressable>
