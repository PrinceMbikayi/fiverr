 ...
 * 
 */
export const GatesCommonWidget = (props) => {
        ...
        <Pressable disabled={true} onPress={() => console.log("Tuile Pressed")} style={{ flex: 1, width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', borderRadius: 12, }}>
            ...
            <View style={{
                ...
                <View style={{ flexDirection: 'column', marginLeft: 5 }}>
                    <Text style={{ fontSize: 14, fontWeight: "300", color: textColor, flexWrap: 'nowrap', backgroundColor: 'transparent', textAlign: 'center', marginLeft:0 }}>
                        {statusMsg}
                    </Text>
                </View>
                    ...
                    {isToggleMode ?
                        <>
                            {isRoutine ?
                                ...
                                >
                                    <Text style={{ fontSize: 16, fontWeight: '600', color: actionActive ? 'white' : textColor }}>
                                        {t(tns + ":" + "GATE_DOOR_ACTION")}
                                    </Text>
                                </Pressable>
