...
export const LightLevel2Details = (props) => {
    ...
    const productName = uObject?.statuses?.product_name
    console.log("Light Detail :", productName)
            ...
            <View style={[styles.bodyWrapper,{backgroundColor:bgcolor, margin:10, borderColor:borderColor}]}>
                <View style={[
                    ...
                    width:'100%',height:'100%',
                        ...
                        <View style={{justifyContent:'center', alignItems:'flex-start', paddingTop:20, paddingBottom:20}}>
                            <LightPlugWidget 
                                itemId = {itemId} 
                                iconSize = {52} 
                                isLight 
                                    ...
                                    <View style={{flexDirection:'row', marginBottom:20, marginTop:20}}>
                                        <View>
                                            <MultiPurposeWidgetLine 
                                                ...
                                                iconColor = 'orange'
                                                //iconWrapperStyle = {{ marginRight:(Platform.OS === 'ios')? 0 : -5 }}
                                            />
                                        </View>
                                       
                                            <View>
                                                <Slider
                                                    style={{width: 220, height: 30, marginLeft:5}}
                                                    minimumValue={0}
                                                    maximumValue={100}
                                                    step ={1}
                                        ...
                                        <View>
                                            <MultiPurposeWidgetLine 
                                                ...
                                                iconBgColor ={'transparent'}
                                                iconColor = 'orange'
                                               //iconWrapperStyle = {{marginLeft:(Platform.OS === 'ios')? 0 : -10}}
                                            />
                                        </View>
                                    </View>
                                }
