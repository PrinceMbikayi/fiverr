...
export const SensorsSettings = (props) => {
    ...
    const handleSubmit = async (values) => {
        ...
        // const action3 = Actions.updateRDependenciesHarold(lstGroup[0], itemId);
        // dispatch(action3);
        ...
        <ScreenContainer headerTitle={uObject.name}>
             <View style={styles.bodyContent}>
                <RenameObject
                    ref={renameRef}
                    oldName = {oldName}
                    renameText="Renommer votre équipement:"
                    handleSubmit={handleSubmit}
                />

                <RoomSelection
                    title="Dans quelle pièce se trouve cet équipement ?"
                    options={data}
                    setSelected={setRoom}
                ...
                <View style={styles.validateButton}>
                    <Button onPress={submitMe} altStyle title='Submit' titleColor="#FFFFFF" bgColor="#3E495E" noBorder />
                </View>
