...
export const Graphs = (props) => {
    ...
    const [dataForChartKit, setDataForChartKit] = useState();
    ...
    const grabDatas = async() => {
        ...
        if((isMounted && requestResult.errCode == 200)){
            ...
            for (const [key, value] of Object.entries(testData)) {
              ...
              setTypeGraphList(tempListGraph)
              setDataForChartKit(tempChartKitData)
              //console.log("GRAPH LIST :", typeGraphList)
    ...
    useEffect(()=>{
        console.log("GRAPH LIST    :", typeGraphList, dataForChartKit)

    },[typeGraphList])

    useEffect(()=>{
        console.log("CHARTKIT DATA    :", dataForChartKit)
