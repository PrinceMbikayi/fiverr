...
class ScheduleTaskPicker extends Component {
  constructor(props) {
    ...
    var {
      ...
      withTimeText = (props.withTimeText = true),
    } = props;
    ...
    this.state = {
      ...
      currentSelections: {
        regularTime: initTime,
        sunrise: initialOffsetIndex,
        sunset: initialOffsetIndex,
      },
  ...
  formatSendbackDatas = pickerId => {
    ...
    switch (pickerId) {
      ...
      case 'sunset':
        ...
        console.log('PICKER_SELECTED_DATA_WEATHER:', {
          event: event,
          offset: offset,
          weatherId: userWeather,
        });
        ...
        <View style={{}}>
          <View
            ...
            {this.state.isMounted && (
              <View
                id="tabContents"
                style={{flex: 2, height: Platform.OS == 'android' ? 190 : 200}}>
                <View
                  style={[
                ...
                <View
                  ...
                  <SunPicker
                    ...
                    pickerId="sunrise"
                    initialPosition={this.state.currentSelections['sunrise']}
                ...
                <View
                  ...
                  <SunPicker
                    ...
                    pickerId="sunset"
                    initialPosition={this.state.currentSelections['sunset']}
                    callback={this.pickerSelectionCallback}
                  />
                </View>
              </View>
