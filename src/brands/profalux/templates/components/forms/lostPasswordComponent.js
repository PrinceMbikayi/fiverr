       ...
       <Formik
             ...
             return (
               <>
                  ...
                  <View style={{backgroundColor:'transparent'}}>
                    <FormInput  name='login' value={values.login}  placeholder={t('Enter email')}  autoCapitalize='none' keyboardType='email-address' onChangeText = {onChangeWithRulesExternal('login',noSpace)(values,setFieldValue)} returnKeyType={'next'}   bgColor={bgColor} addTestId={loginID}/>             
                    </View>
