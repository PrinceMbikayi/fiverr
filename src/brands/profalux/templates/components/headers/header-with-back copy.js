...
export const HeaderWithBack = (props) => {
    ...
    const {
        title, noShadow, themeDependency, pop,
    ...
    //             <PopupMenu options={options} handleAction={handleAction}/>
    //         </View>
    //     )       
    // }
    ...
    return (
        <View style={{ height: 55 }}>
            <View style={{ flex: 1, backgroundColor: 'white', borderBottomColor: borderColor, borderBottomWidth: 2, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', width: '100%'}}>
                ...
                <View style={{ backgroundColor: 'red', flex: 1, marginLeft:titleMarginLeft,  width: '100%' }}>
                    <Text numberOfLines={2} ellipsizeMode='tail' style={{ color: textColor, fontSize: 20, fontWeight: '600', backgroundColor: 'transparent', width: '100%' }}>
                        {title}
                    </Text>
                </View>
