...
//const server = "//umii.avidsen.one"


//const server = "//airhome.app"
//const server = "//demo.athemium.com";
//const server ="//athome.avidsen.one";
//const server ="//donkey.athemium.com";
//const server = "//profalux.avidsen.one";
...
export const HIDDEN_OBJECTS = [ 'Mobile','Notifications','Gateway','EnOcean','ZWave','Scheduler','SchedulerTask','Scenario',
             ...
             /**
              *  @type {{ACCOUNT, PROGRAMMATION, HOME,SETTINGS,ABOUT,GROUP_HOME,GROUP,HomeGroup, MAISON_SCREEN}} 
              * 
              */                   
export const appRoutesNames = { 
                                ...
                                "GROUP_HOME" : "ProfaluxGroupHomeScreen",
                                "GROUP_SELECTION" : "GroupSelectionScreen",
                                "GROUP_MODIFY" : "GroupModifyScreen",
                                "GROUP_ADD" : "GroupAddScreen",
                                "ROOMS" : 'Rooms',
                                "ROOM" : "Room",
                                "GROUP" : "Group",
                                "MAISON_SCREEN" : "MaisonScreen",
...
export const multiServers = [
                                ...
                                //{label:'preprod',url:'https://preprod-profalux-v2.avidsen.one'}
                            ]
...
//{label:'umii',url:'https://umii.avidsen.one'},
// {label:'demo',url:'https://demo.athemium.com'},
// {label:'test',url:'https://test.avidsen.one'},
// {label:'profalux', url:'https://profalux.avidsen.one'},
